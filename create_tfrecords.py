...
flags.DEFINE_string('dataset_dir', 'C:/Innefu/data/flower/flower', 'String: Your dataset directory')
...
flags.DEFINE_string('tfrecord_filename', 'flower', 'String: The output filename to name your TFRecord file')
